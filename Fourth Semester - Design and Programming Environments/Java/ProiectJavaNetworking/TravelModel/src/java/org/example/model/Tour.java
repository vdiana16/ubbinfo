...
public class Tour extends Entity<Integer> {
    ...
    public Tour(String destination, String transportCompany, LocalDateTime departureDate, Double price, Integer numberOfAvailableSeats) {
