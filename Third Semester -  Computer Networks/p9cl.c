...
//Un client trimite unui server doua siruri de numere. Serverul va returna clientului sirul de
//numere care se regaseste in primul sir dar nu se regasesc in al doilea.
...
int main(int argc, char* argv[]) {
	...
	struct structNr s1 = numereDinSir(sirnr);
        ...
        if (lungimesir == 0) {
                printf("Nu exista numere care sa se regaseasca doar in primul sir.\n");
        }
        else {
